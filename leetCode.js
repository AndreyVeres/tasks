...

{
    ...
    const input1 = 3;   //    "III"
    const input2 = 58;  //    "LVIII"
    const input3 = 1994;//    "MCMXCIV"
    ...
    console.log(intToRoman(input1))
    console.log(intToRoman(input2))
    console.log(intToRoman(input3))
...

{
    ...
    function zeroMatrix(matrux) {
        for (let i = 0; i < matrux.length; i++) {
            for (let j = 0; j < matrux[0].length; j++) {
                if (matrux[i][j] === 0) {
                    matrux[i][0] = 0
                    matrux[0][j] = 0
                }
